...
An important finding from measuring the computation time is that the performance impact of all tested transformations is constant in regard to the input size. 

\begin{figure}[!h]
    \centering
    \includegraphics[height=0.4\textheight]{sha_bench.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[height=0.4\textheight]{aes_bench.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[height=0.4\textheight]{qs_bench.pdf}
